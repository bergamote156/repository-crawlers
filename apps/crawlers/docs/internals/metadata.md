...
<sub>source: `apps/crawlers/src/crawlers/metadata/datacite.py#DataCiteRecord`</sub>
...
<sub>source: `apps/crawlers/src/crawlers/metadata/datacite.py#_build`</sub>
...
<sub>source: `apps/crawlers/src/crawlers/plugins/eodc/parser.py#_parse_item`</sub>
...
<sub>source: `apps/crawlers/src/crawlers/metadata/openaire.py#OpenAIRERecord`</sub>
...
<sub>source: `apps/crawlers/src/crawlers/metadata/openaire.py#_build`</sub>
...
<sub>source: `apps/crawlers/src/crawlers/plugins/ecudo/parser.py#parse_ecudo_record`</sub>
